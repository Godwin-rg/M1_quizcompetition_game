    ...
    void start()
    {
            ...
            printf("Q(1).The world smallest country is \n 1.Vatican City \t\t2.Maldives\n 3.Bhutan\t\t 4.Costa Rica\n\n");
            ...
            {
                printf("Wrong answer! Correct answer is 1.Vatican City\n\n");
            }

            printf("Q(2)  The metal whose salts are sensitive to lights is \n 1.Zinc\t\t2.Silver \n3.Copper\n4.Aluminium\n\n");
            printf("Your answer: ");
            scanf("%d",&ans);
            ...
            {
                printf("Wrong answer! Correct answer is 2.Silver\n\n");
            }

            printf("Q(3)  The country that has the highest in Barley Production\n1.China\t\t2.Russia\n3.India\t4.France\n\n");
            ...
            {
                printf("Wrong answer! Correct answer is 2.Russia\n\n");
            }
